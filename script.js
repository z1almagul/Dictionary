...
const words = [
    {word: "en arbeidsinnvandrer",
     ...
     type:0},
    {word: "en lungebetennelse",
     translation: "a pneumonia",
     definition:"pneumonia ",
     example: "Datteren min har lungebetennelse.",
     type:0},
    {word: "å klare",
     translation: "to manage",
     definition:"å mestre",
     example:"Jeg klarer det!.",
     type:1},
    {word: "en beskjed",
     translation: "a message",
     definition:"en meddelelse, opplysning",
     example:"Jeg har fått beskjed fra legen.",
     type:0},
    {word: "en snekker",
